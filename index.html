                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="assets/images/Q%20_N_%20TRACE_free-file%20(3).png" alt="Logo">
                        </a>
                        ...
                        <div class="navbar-btn d-none d-sm-inline-block">
                            <ul>
                                <li><a class="solid" href="customer/log%20in.php">SIGN IN</a></li>
                            </ul>
                        </div>
                    </nav> <!-- navbar -->
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    ...
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="customer/sign%20up.php">SIGN UP</a></li>
                                        <li><a class="main-btn rounded-two"  href="customer/log%20in.php">SIGN IN</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div> <!-- row -->
